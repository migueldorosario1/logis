...
export const REPORTAGENS: Reportagem[] = [
  {
    ...
    corpo: {
      pt: [
        ...
        "Gasta-se cerca de 19,5% do PIB, algo como R$ 1,7 trilhão por ano, apenas para mover mercadorias pelo Brasil, segundo estimativas do próprio setor produtivo. Dentro dessa conta vive uma economia ilegal calculada por fóruns de combate à pirataria em cerca de R$ 500 bilhões em 2025.",
        ...
        "O custo por unidade, pela estimativa do projeto básico, fica abaixo de dois reais. Entre o tamanho do problema e o preço da ferramenta, a relação é de milhares para um.",
        "A ideia, aliás, é mais velha do que parece. O selo fiscal é figura clássica do direito tributário brasileiro, presente na Lei 4.502, de 1964, e no regulamento do IPI, o Decreto 7.212, de 2010, que já previam o controle de mercadorias por selo e timbre.",
        ...
        "O artigo 170, por sua vez, só faz sentido com todos no mesmo jogo. Livre concorrência e defesa do consumidor pressupõem que cada competidor pague o mesmo preço institucional para estar em campo.",
        ...
        "É esse passaporte que falta à reindustrialização em curso. A Nova Indústria Brasil organiza crédito e incentivos em torno de grandes missões, e todas elas terminam numa fábrica que precisará vender contra o produto clandestino.",
