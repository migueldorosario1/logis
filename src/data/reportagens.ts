...
export const REPORTAGENS: Reportagem[] = [
  {
    ...
    notas: {
      pt: [
        ...
        '**Custo unitário do selo (abaixo de dois reais).** Estimativa do projeto básico de engenharia, somando valor de referência para licitação e provisão operacional do fabricante. O preço final depende de contratação pública.',
