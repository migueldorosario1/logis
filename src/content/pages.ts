  ...
  home: {
    pt: {
      ...
      blocos: [
        ...
        { t: 'Artigos Científicos', slug: 'artigos', x: 'Artigos publicados pela Revista Logis em acesso aberto diamante — o primeiro, «Controle Logístico Nacional», já está disponível para leitura e download.' },
      ],
    ...
    en: {
      ...
      blocos: [
        ...
        { t: 'Scientific Articles', slug: 'artigos', x: 'Papers published by the Logis Journal in diamond open access — the first, “National Logistics Control”, is already available to read and download.' },
      ],
    ...
    es: {
      ...
      blocos: [
        ...
        { t: 'Artículos Científicos', slug: 'artigos', x: 'Artículos publicados por la Revista Logis en acceso abierto diamante — el primero, «Control Logístico Nacional», ya está disponible para lectura y descarga.' },
      ],
